...
# 77 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_direction_intialize(const pin_config_t *_pin_config);
# 87 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t *_pin_config,direction_t *direction_status);
# 97 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_write_logic(const pin_config_t *_pin_config ,logic_t logic);
# 107 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_read_logic(const pin_config_t *_pin_config ,logic_t *logic);
# 116 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t *_pin_config);
# 125 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
Std_ReturnType gpio_pin_intialize(const pin_config_t *_pin_config);
# 137 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
Std_ReturnType gpio_port_direction_intialize(port_index_t port, uint8 direction);
# 147 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
Std_ReturnType gpio_port_get_direction_status(port_index_t port,uint8 *direction_status);
# 159 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
Std_ReturnType gpio_port_write_logic(port_index_t port ,uint8 logic);
# 168 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
Std_ReturnType gpio_port_read_logic(port_index_t port ,uint8 *logic);
# 177 "MCAL_Layer/ADC/../GPIO/hal_gpio.h"
...
static Std_ReturnType adc_input_channel_port_configure(adc_channel_select_t channel){
    Std_ReturnType ret = (Std_ReturnType)0x00;
    switch(channel){
        case ADC_CHANNEL_AN0 : (TRISA |= ((uint8)1 << 0x0)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN1 : (TRISA |= ((uint8)1 << 0x1)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN2 : (TRISA |= ((uint8)1 << 0x2)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN3 : (TRISA |= ((uint8)1 << 0x3)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN4 : (TRISA |= ((uint8)1 << 0x5)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN5 : (TRISE |= ((uint8)1 << 0x0)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN6 : (TRISE |= ((uint8)1 << 0x1)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN7 : (TRISE |= ((uint8)1 << 0x2)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN8 : (TRISB |= ((uint8)1 << 0x2)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN9 : (TRISB |= ((uint8)1 << 0x3)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN10 : (TRISB |= ((uint8)1 << 0x1)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN11 : (TRISB |= ((uint8)1 << 0x4)); ret = (Std_ReturnType)0x01; break;
        case ADC_CHANNEL_AN12 : (TRISB |= ((uint8)1 << 0x0)); ret = (Std_ReturnType)0x01; break;
